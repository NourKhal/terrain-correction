...
shared_folder = '/data'
input_file = os.path.join(shared_folder, os.environ['input_file'])
###################################################################
#  SET THIS VARIABLE
#
...
# args = ["data/S1A_IW_GRDH_1SDV_20150513T100637_20150513T100702_005901_0079A1_E274.zip"]
...
def getZone(inData, tdir):
    temp = tdir + '/' + os.path.basename(inData).replace('.zip','.SAFE')
...
tempFile = infile
(zone, cm, hemi) = getZone(infile, tdir)
